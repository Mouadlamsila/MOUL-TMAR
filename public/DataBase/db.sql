...
VALUES
    ...
    ('الخلاص', 'السعودية', 'شبه جاف', 'تمر متوسط الحجم، شبه طري، بنكهة غنية تشبه الكراميل.', 'مفيد للطاقة والنشاط', 30.00, 'images/khallas.jpg'),
    ('البرحي', 'العراق', 'طري', 'تمر صغير، طري، ولذيذ، يُؤكل طازجًا أو مجففًا.', 'غني بالسكريات الطبيعية', 30.00, 'images/barhi.jpg'),
    ...
    ('الصفاوي', 'السعودية', 'طري', 'تمر مشابه للعجوة، داكن وحلو قليلًا.', 'غني بالمعادن والألياف', 60.00, 'images/safawi.jpg'),
    ('السكري', 'السعودية', 'طري', 'تمر حلو جدًا ومثالي للاستخدام في الحلويات.', 'مصدر طبيعي للطاقة', 40.00, 'images/sukkari.jpg'),
    ('الزهدي', 'العراق', 'شبه جاف', 'تمر ذهبي، بطعم جوزي وخفيف الحلاوة.', 'عالي بالألياف ومنخفض الدهون', 60.00, 'images/zahdi.jpg'),
    ('العنبره', 'السعودية', 'طري', 'تمر كبير الحجم وغني بالقيمة الغذائية.', 'مفيد للطاقة والنشاط', 60.00, 'images/ambera.jpg'),('الخضري', 'السعودية', 'جاف', 'تمر بني داكن، طويل العمر التخزيني.', 'مصدر غني بالألياف', 60.00, 'images/khodri.jpg'),
    ...
    ('نبتة علي', 'السعودية', 'شبه جاف', 'تمر متوسط الحجم، بني ذهبي.', 'مفيد للصحة العامة', 40.00, 'images/nabta_ali.jpg'),('الجيهل', 'المغرب', 'شبه جاف', 'تمر طويل وداكن، يُقدم مع القهوة.', 'غني بالطاقة', 40.00, 'images/jihl.jpg'),
    ('الخلاصه', 'الإمارات', 'شبه جاف', 'تمر حلو جدًا ولزج.', 'مناسب للحلويات', 30.00, 'images/khalasa.jpg');